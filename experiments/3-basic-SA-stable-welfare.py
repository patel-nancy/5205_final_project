  ...
  for ranking in rankings:
    ...
    for final_arrangement in final_arrangements:
      ...
      if(is_stable(profile, final_arrangement)):
        num_stable += 1
        break
        max_welfare = max(max_welfare, calculate_total_utility(profile, final_arrangement))
    ...
    if(num_stable == 0):
      ...
      if(stable_exists):
        ...
        for stable_arr in stable_arrs:
          #TODO: format!
          print("Welfare for Stable Arrangement:", calculate_total_utility(profile, stable_arr))
          print("Stable Arrangement:", stable_arr)

        print("Max Welfare:", max_welfare)
        print("--------")
      else:
